...
//    Command line =  
//        -f C:\Users\19071_~1\AppData\Local\Temp\EWDECD.tmp
...
//    Locale       =  C
//    List file    =  
//        C:\Users\19071_000\Desktop\K60_Car\program\program\iar\RAM\List\HW_CAN.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  267                          | CAN_CTRL1_PRESDIV(prescale)); 
        UXTB     R0,R0            ;; ZeroExt  R0,R0,#+24,#+24
        LDR.W    R1,??DataTable19_23  ;; 0x10003
...
//  282                          | CAN_CTRL1_PRESDIV(prescale)); 
        UXTB     R0,R0            ;; ZeroExt  R0,R0,#+24,#+24
        LDR.W    R1,??DataTable19_24  ;; 0x9b0002
        ORRS     R1,R1,R0, LSL #+24
        STR      R1,[R4, #+4]
//  283         break;
        B.N      ??LPLD_CAN_SetBaudRate_5
...
//  296                          | CAN_CTRL1_PRESDIV(prescale)); 
        UXTB     R0,R0            ;; ZeroExt  R0,R0,#+24,#+24
        LDR.W    R1,??DataTable19_25  ;; 0x5b0002
        ORRS     R1,R1,R0, LSL #+24
        STR      R1,[R4, #+4]
//  297         break;
        B.N      ??LPLD_CAN_SetBaudRate_5
...
//  347     
//  348   if(canx == CAN0)
        LDR.W    R1,??DataTable19_5  ;; 0x40024000
        CMP      R0,R1
...
??LPLD_CAN_EnableIrq_0:
        LDR.W    R1,??DataTable19_26  ;; 0x400a4000
        CMP      R0,R1
...
//  419       id_temp =  CAN_MB_ID_STD(rx_id);
        LDR      R3,[SP, #+32]
        LDR.W    R1,??DataTable19_27  ;; 0x1ffc0000
        ANDS     R1,R1,R3, LSL #+18
...
//  502       id_temp =  CAN_MB_ID_STD(message_id);
        LDR.W    R0,??DataTable19_27  ;; 0x1ffc0000
        ANDS     R0,R0,R5, LSL #+18
...
//  516                                      CAN_MB_CS_DLC(in_data_length);
        ...
        UXTB     R10,R10          ;; ZeroExt  R10,R10,#+24,#+24
        LSLS     R10,R10,#+16
        ANDS     R10,R10,#0xF0000
        ORRS     R10,R10,R0
        ORRS     R10,R10,#0xC000000
        UXTB     R6,R6            ;; ZeroExt  R6,R6,#+24,#+24
        LSLS     R0,R6,#+4
        ADD      R0,R7,R0
        STR      R10,[R0, #+128]
...
??LPLD_CAN_Transmit_Interrupt_1:
        LDR.N    R0,??DataTable19_26  ;; 0x400a4000
        CMP      R5,R0
...
CAN0_BUS_OFF_IRQHandler:
        MOVS     R0,#+4
        LDR.N    R1,??DataTable19_31  ;; 0x40024020
        STR      R0,[R1, #+0]
...
CAN0_ERR_IRQHandler:
        LDR.N    R0,??DataTable19_31  ;; 0x40024020
        LDR      R0,[R0, #+0]
// 1101 
...
CAN1_BUS_OFF_IRQHandler:
        MOVS     R0,#+4
        LDR.N    R1,??DataTable19_32  ;; 0x400a4020
        STR      R0,[R1, #+0]
...
CAN1_ERR_IRQHandler:
        LDR.N    R0,??DataTable19_32  ;; 0x400a4020
        LDR      R0,[R0, #+0]
// 1148 
...
?_0:
        ...
        DC8 57H, 5FH, 43H, 41H, 4EH, 2EH, 63H, 0
