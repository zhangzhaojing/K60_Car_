...
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  C:\Users\19071_000\Desktop\K60_Car\lib\LPLD\HW\HW_SDHC.c
//    Command line =  
//        -f C:\Users\19071_~1\AppData\Local\Temp\EWE64E.tmp
//        (C:\Users\19071_000\Desktop\K60_Car\lib\LPLD\HW\HW_SDHC.c -D LPLD_K60
//        -D USE_K60DZ10 -lCN
...
//    Locale       =  C
//    List file    =  
//        C:\Users\19071_000\Desktop\K60_Car\program\program\iar\RAM\List\HW_SDHC.s
//
///////////////////////////////////////////////////////////////////////////////
...
// C:\Users\19071_000\Desktop\K60_Car\lib\LPLD\HW\HW_SDHC.c
//    1 /**
//    2  * @file HW_SDHC.c
...
//  171   SDHC->SYSCTL = SDHC_SYSCTL_RSTA_MASK | SDHC_SYSCTL_SDCLKFS(0x80);
        LDR.W    R0,??DataTable8_10  ;; 0x1008000
        LDR.W    R1,??DataTable8_7  ;; 0x400b102c
        STR      R0,[R1, #+0]
...
//  176   SDHC->VENDOR = 0;
        MOVS     R0,#+0
        LDR.W    R1,??DataTable8_11  ;; 0x400b10c0
        STR      R0,[R1, #+0]
...
//  178   SDHC->PROCTL = SDHC_PROCTL_EMODE(ESDHC_PROCTL_EMODE_LITTLE) | SDHC_PROCTL_D3CD_MASK;
        MOVS     R0,#+40
        LDR.W    R1,??DataTable9_1  ;; 0x400b1028
        STR      R0,[R1, #+0]
//  179   SDHC->WML = SDHC_WML_RDWML(2) | SDHC_WML_WRWML(1);
        LDR.W    R0,??DataTable8_13  ;; 0x10002
        LDR.W    R1,??DataTable8_14  ;; 0x400b1044
        STR      R0,[R1, #+0]
//  180   
...
//  196         | SDHC_IRQSTATEN_TCSEN_MASK | SDHC_IRQSTATEN_CCSEN_MASK;
        LDR.W    R0,??DataTable8_15  ;; 0x7f00b3
        LDR.W    R1,??DataTable8_16  ;; 0x400b1034
        STR      R0,[R1, #+0]
//  197   
//  198   //等待80个初始时钟
...
??LPLD_SDHC_SendCommand_5:
        LDR.W    R1,??DataTable8_8  ;; 0x400b1024
        LDR      R1,[R1, #+0]
        LSLS     R1,R1,#+31
...
//  273   SDHC->CMDARG = command->ARGUMENT;
        LDR      R1,[R4, #+4]
        LDR.W    R2,??DataTable10  ;; 0x400b1008
        STR      R1,[R2, #+0]
...
??LPLD_SDHC_IOC_20:
        LDR      R0,[SP, #+16]
        CMP      R0,#+0
        BMI.N    ??LPLD_SDHC_IOC_21
        CMP      R8,#+100
        BLT.N    ??LPLD_SDHC_IOC_18
        B.N      ??LPLD_SDHC_IOC_21
...
??LPLD_SDHC_IOC_29:
        ...
        LSRS     R0,R0,#+8
        CMP      R0,#+206
        BNE.N    ??LPLD_SDHC_IOC_30
        MOVS     R0,#+1
        B.N      ??LPLD_SDHC_IOC_31
??LPLD_SDHC_IOC_30:
        MOVS     R0,#+0
??LPLD_SDHC_IOC_31:
        UXTB     R0,R0            ;; ZeroExt  R0,R0,#+24,#+24
        CMP      R0,#+0
        BEQ.N    ??LPLD_SDHC_IOC_24
//  471         {
...
??LPLD_SDHC_IOC_32:
        ...
        LSRS     R0,R0,#+8
        CMP      R0,#+170
        BNE.N    ??LPLD_SDHC_IOC_33
        MOVS     R0,#+1
        B.N      ??LPLD_SDHC_IOC_34
??LPLD_SDHC_IOC_33:
        MOVS     R0,#+0
??LPLD_SDHC_IOC_34:
        UXTB     R0,R0            ;; ZeroExt  R0,R0,#+24,#+24
...
//  516             if (hc)
        ...
        CMP      R5,#+0
        BEQ.N    ??LPLD_SDHC_IOC_39
//  517             {
//  518               command.ARGUMENT = 0x40300000;
        LDR.W    R0,??DataTable11_2  ;; 0x40300000
        STR      R0,[SP, #+4]
        B.N      ??LPLD_SDHC_IOC_40
//  519             }
??LPLD_SDHC_IOC_37:
        B.N      ??LPLD_SDHC_IOC_41
//  520             else
//  521             {
...
??LPLD_SDHC_IOC_43:
        LDR      R0,[SP, #+16]
        CMP      R0,#+0
        BMI.N    ??LPLD_SDHC_IOC_41
        CMP      R8,#+100
        BLT.N    ??LPLD_SDHC_IOC_36
        B.N      ??LPLD_SDHC_IOC_41
...
??LPLD_SDHC_IOC_3:
        CMP      R5,#+0
        BNE.N    ??LPLD_SDHC_IOC_52
//  601     {
//  602       result = SDHCRES_ERROR;
        MOVS     R4,#+1
        B.N      ??LPLD_SDHC_IOC_53
//  603     }
//  604     else
//  605     {
//  606       //获取波特率
...
//  615       result = SDHCRES_ERROR;
        MOVS     R4,#+1
        B.N      ??LPLD_SDHC_IOC_55
//  616     }
//  617     else if (0 == (*param32_ptr))
??LPLD_SDHC_IOC_54:
        LDR      R0,[R5, #+0]
        CMP      R0,#+0
        BNE.N    ??LPLD_SDHC_IOC_56
//  618     {
...
??LPLD_SDHC_IOC_58:
        LDR.W    R0,??DataTable9_1  ;; 0x400b1028
        LDR      R0,[R0, #+0]
        UBFX     R8,R0,#+1,#+2
...
??LPLD_SDHC_IOC_2:
        CMP      R5,#+0
        BNE.N    ??LPLD_SDHC_IOC_69
//  705     {
//  706       result = SDHCRES_ERROR;
        MOVS     R4,#+1
        B.N      ??LPLD_SDHC_IOC_70
//  707     }
//  708     else
//  709     {
//  710       //等待80个时钟
...
??LPLD_SDHC_Read_2:
        LDR.N    R3,??DataTable8_8  ;; 0x400b1024
        LDR      R3,[R3, #+0]
        LSLS     R3,R3,#+20
...
??LPLD_SDHC_Read_3:
        LDR.W    R3,??DataTable11_6  ;; 0x400b1020
        LDR      R3,[R3, #+0]
        STR      R3,[R2, #+0]
//  789       data_ptr += 4;
        ADDS     R2,R2,#+4
...
??LPLD_SDHC_Read_1:
        ...
        LDR.W    R3,??DataTable9  ;; 0x400b1030
        LDR      R3,[R3, #+0]
        TST      R3,#0x700000
...
//  888       SDHC->DATPORT = *((uint32 *)udata_ptr);
        LDR      R3,[R2, #+0]
        LDR.W    R4,??DataTable11_6  ;; 0x400b1020
        STR      R3,[R4, #+0]
//  889       udata_ptr += 4;
        ADDS     R2,R2,#+4
//  890       remains -= 4;
...
??LPLD_SDHC_Write_1:
        ...
        ORR      R0,R0,#0x700000
        ORRS     R0,R0,#0x10
        LDR.N    R1,??DataTable9  ;; 0x400b1030
        STR      R0,[R1, #+0]
        MOVS     R0,#+1
...
??LPLD_SDHC_Write_0:
        CMP      R0,#+4
        BLT.N    ??LPLD_SDHC_Write_3
        LDR.N    R3,??DataTable9  ;; 0x400b1030
        LDR      R3,[R3, #+0]
        TST      R3,#0x700000
...
??LPLD_SDHC_Write_11:
        LDR.N    R2,??DataTable8_8  ;; 0x400b1024
        LDR      R2,[R2, #+0]
        LSLS     R2,R2,#+21
...
??LPLD_SDHC_InitCard_8:
        LDR.W    R0,??DataTable11_8  ;; 0x2090000
        STR      R0,[SP, #+4]
...
??LPLD_SDHC_InitCard_11:
        LDR.W    R0,??DataTable11_9  ;; 0x31a0000
        STR      R0,[SP, #+4]
...
// 1041   command.COMMAND = ESDHC_CMD9;
        LDR.N    R0,??DataTable11_10  ;; 0x9090000
        STR      R0,[SP, #+4]
...
??LPLD_SDHC_InitCard_16:
        LDR.N    R0,??DataTable11_11  ;; 0x71b0000
        STR      R0,[SP, #+4]
...
??LPLD_SDHC_InitCard_17:
        LDR.N    R0,??DataTable11_12  ;; 0x101a0000
        STR      R0,[SP, #+4]
...
??LPLD_SDHC_InitCard_19:
        LDR.N    R0,??DataTable11_13  ;; 0x61a0000
        STR      R0,[SP, #+4]
...
??LPLD_SDHC_WriteBlocks_9:
        LDR      R0,[SP, #+20]
        LDR.N    R1,??DataTable11_18  ;; 0xffd98008
        TST      R0,R1
...
??LPLD_SDHC_WriteBlocks_8:
        LDR.N    R0,??DataTable11_19  ;; 0xd1a0000
        STR      R0,[SP, #+4]
        LDR.N    R0,??DataTable11_7
        LDR      R0,[R0, #+0]
        LDR      R0,[R0, #+12]
...
??LPLD_SDHC_WriteBlocks_16:
        ...
        BL       LPLD_SDHC_IOC
        CMP      R0,#+0
        BEQ.N    ??LPLD_SDHC_WriteBlocks_17
// 1290         {
...
// 1295         if ((cnt < 0) || (cnt > count))
        CMP      R6,#+0
        BMI.N    ??LPLD_SDHC_WriteBlocks_18
        CMP      R4,R6
        BCS.N    ??LPLD_SDHC_WriteBlocks_13
// 1296             return SDHCRES_ERROR;
??LPLD_SDHC_WriteBlocks_18:
        MOVS     R0,#+1
        B.N      ??LPLD_SDHC_WriteBlocks_4
// 1297     }
// 1298     
...
// 3 962 bytes in section .text
// 
// 3 962 bytes of CODE memory
