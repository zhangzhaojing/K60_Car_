...
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  C:\Users\19071_000\Desktop\K60_Car\lib\LPLD\HW\HW_ENET.c
//    Command line =  
//        -f C:\Users\19071_~1\AppData\Local\Temp\EWE0E3.tmp
//        (C:\Users\19071_000\Desktop\K60_Car\lib\LPLD\HW\HW_ENET.c -D LPLD_K60
//        -D USE_K60DZ10 -lCN
...
//    Locale       =  C
//    List file    =  
//        C:\Users\19071_000\Desktop\K60_Car\program\program\iar\RAM\List\HW_ENET.s
//
///////////////////////////////////////////////////////////////////////////////
...
// C:\Users\19071_000\Desktop\K60_Car\lib\LPLD\HW\HW_ENET.c
//    1 /**
//    2  * @file HW_ENET.c
...
__NVIC_EnableIRQ:
        ...
        ANDS     R1,R0,#0x1F
        LSLS     R2,R2,R1
        LDR.W    R1,??DataTable14  ;; 0xe000e100
        SXTB     R0,R0            ;; SignExt  R0,R0,#+24,#+24
        LSRS     R0,R0,#+5
        STR      R2,[R1, R0, LSL #+2]
??__NVIC_EnableIRQ_0:
...
??LPLD_ENET_MacSend_1:
        MOVS     R0,#+16777216
        LDR.N    R1,??DataTable14_46  ;; 0x400c0014
        STR      R0,[R1, #+0]
//  437   
//  438 }
        BX       LR               ;; return
...
??LPLD_ENET_HashAddress_5:
        LSRS     R0,R0,#+1
        B.N      ??LPLD_ENET_HashAddress_6
??LPLD_ENET_HashAddress_4:
        LSRS     R0,R0,#+1
        LDR.N    R1,??DataTable14_47  ;; 0xedb88320
        EORS     R0,R1,R0
//  511       byte >>= 1;
??LPLD_ENET_HashAddress_6:
        UXTB     R3,R3            ;; ZeroExt  R3,R3,#+24,#+24
        LSRS     R3,R3,#+1
//  512     }
        ADDS     R5,R5,#+1
...
LPLD_ENET_MiiInit:
        ...
        LSLS     R0,R0,#+1
        ANDS     R0,R0,#0x7E
        LDR.N    R1,??DataTable14_50  ;; 0x400c0044
        STR      R0,[R1, #+0]
//  566 }
        BX       LR               ;; return
//  567 
...
//  587   ENET->EIR = ENET_EIR_MII_MASK;
        MOVS     R3,#+8388608
        LDR.N    R4,??DataTable14_37  ;; 0x400c0004
        STR      R3,[R4, #+0]
//  588   
//  589   //初始化MII管理帧寄存器
//  590   ENET->MMFR = 0
...
//  596             | ENET_MMFR_DATA(data);
        ...
        ORRS     R0,R2,R0
        LDR.N    R1,??DataTable14_51  ;; 0x50020000
        ORRS     R0,R1,R0
        LDR.N    R1,??DataTable14_52  ;; 0x400c0040
        STR      R0,[R1, #+0]
//  597   
//  598   //等待MII传输完成中断事件
...
??LPLD_ENET_MiiWrite_0:
        LDR.N    R1,??DataTable14_53  ;; 0x1ffff
        CMP      R0,R1
        BCS.N    ??LPLD_ENET_MiiWrite_2
//  600   {
//  601     if (ENET->EIR & ENET_EIR_MII_MASK)
        LDR.N    R1,??DataTable14_37  ;; 0x400c0004
        LDR      R1,[R1, #+0]
        LSLS     R1,R1,#+8
...
//  641             | ENET_MMFR_TA(0x02);
        ...
        ANDS     R1,R1,#0x7C0000
        ORRS     R0,R1,R0
        LDR.N    R1,??DataTable14_54  ;; 0x60020000
        ORRS     R0,R1,R0
        LDR.N    R1,??DataTable14_52  ;; 0x400c0040
        STR      R0,[R1, #+0]
//  642   
