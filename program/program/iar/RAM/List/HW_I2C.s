///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V8.10.1.12857/W32 for ARM      30/Dec/2017  19:25:54
// Copyright 1999-2017 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  C:\Users\19071_000\Desktop\K60_Car\lib\LPLD\HW\HW_I2C.c
//    Command line =  
//        -f C:\Users\19071_~1\AppData\Local\Temp\EWE32A.tmp
//        (C:\Users\19071_000\Desktop\K60_Car\lib\LPLD\HW\HW_I2C.c -D LPLD_K60
//        -D USE_K60DZ10 -lCN
...
//    Locale       =  C
//    List file    =  
//        C:\Users\19071_000\Desktop\K60_Car\program\program\iar\RAM\List\HW_I2C.s
//
///////////////////////////////////////////////////////////////////////////////
...
// C:\Users\19071_000\Desktop\K60_Car\lib\LPLD\HW\HW_I2C.c
//    1 /*
//    2  * @file HW_I2C.c
...
//   68       PORTD->PCR[8] = PORT_PCR_MUX(2) | ode_mask;         
        ...
        ORRS     R0,R9,#0x200
        LDR.W    R1,??DataTable7_5  ;; 0x4004c020
        STR      R0,[R1, #+0]
        B.N      ??LPLD_I2C_Init_4
//   69     }
...
//   81       PORTD->PCR[9] = PORT_PCR_MUX(2) | ode_mask;
        UXTB     R9,R9            ;; ZeroExt  R9,R9,#+24,#+24
        ORRS     R9,R9,#0x200
        LDR.N    R0,??DataTable7_8  ;; 0x4004c024
        STR      R9,[R0, #+0]
//   82     }
...
??LPLD_I2C_Init_6:
        ...
        UXTB     R9,R9            ;; ZeroExt  R9,R9,#+24,#+24
        ORRS     R9,R9,#0x200
        LDR.N    R0,??DataTable7_10  ;; 0x4004a004
        STR      R9,[R0, #+0]
        B.N      ??LPLD_I2C_Init_7
??LPLD_I2C_Init_11:
        UXTB     R9,R9            ;; ZeroExt  R9,R9,#+24,#+24
        ORRS     R9,R9,#0x200
        LDR.N    R0,??DataTable7_11  ;; 0x4004a00c
        STR      R9,[R0, #+0]
        B.N      ??LPLD_I2C_Init_7
??LPLD_I2C_Init_2:
        LDR.N    R0,??DataTable7_12  ;; 0x40067000
        CMP      R4,R0
        ...
        UXTB     R9,R9            ;; ZeroExt  R9,R9,#+24,#+24
        ORRS     R0,R9,#0x600
        LDR.N    R1,??DataTable7_13  ;; 0x4004d004
        STR      R0,[R1, #+0]
        B.N      ??LPLD_I2C_Init_14
??LPLD_I2C_Init_13:
        UXTB     R9,R9            ;; ZeroExt  R9,R9,#+24,#+24
        ORRS     R0,R9,#0x200
        LDR.N    R1,??DataTable7_14  ;; 0x4004b028
        STR      R0,[R1, #+0]
??LPLD_I2C_Init_14:
        UXTB     R7,R7            ;; ZeroExt  R7,R7,#+24,#+24
        CMP      R7,#+124
        ...
        UXTB     R9,R9            ;; ZeroExt  R9,R9,#+24,#+24
        ORRS     R9,R9,#0x600
        LDR.N    R0,??DataTable7_15  ;; 0x4004d000
        STR      R9,[R0, #+0]
        B.N      ??LPLD_I2C_Init_7
??LPLD_I2C_Init_15:
        UXTB     R9,R9            ;; ZeroExt  R9,R9,#+24,#+24
        ORRS     R9,R9,#0x200
        LDR.N    R0,??DataTable7_16  ;; 0x4004b02c
        STR      R9,[R0, #+0]
        B.N      ??LPLD_I2C_Init_7
??LPLD_I2C_Init_12:
        MOVS     R0,#+0
...
//  172   i2cx->C1 &= ~I2C_C1_IICEN_MASK;      //I2Cx
        ...
        STRB     R1,[R0, #+2]
//  173   if(i2cx == I2C0)
        LDR.N    R1,??DataTable7_3  ;; 0x40066000
        CMP      R0,R1
...
??LPLD_I2C_Deinit_2:
        POP      {R1,PC}          ;; return
??LPLD_I2C_Deinit_0:
        LDR.N    R1,??DataTable7_12  ;; 0x40067000
        CMP      R0,R1
