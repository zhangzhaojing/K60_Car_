...
//    Locale       =  C
//    List file    =  
//        C:\Users\19071_000\Desktop\K60_Car\program\program\iar\RAM\List\DEV_SCCB.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  155   SCCB_SDA_O=1;
        MOVS     R0,#+1
        LDR.N    R1,??DataTable7_1  ;; 0x43fe0804
        STR      R0,[R1, #+0]
//  156   SCCB_SCL=1;
        MOVS     R0,#+1
        LDR.N    R1,??DataTable7_2  ;; 0x43fe0800
        STR      R0,[R1, #+0]
//  157   SCCB_DELAY();
        MOVW     R0,#+5000
        BL       LPLD_SCCB_Delay
...
//  159   SCCB_SDA_IN();
        MOVS     R0,#+0
        LDR.N    R1,??DataTable7_3  ;; 0x43fe0a84
        STR      R0,[R1, #+0]
//  160   if(!SCCB_SDA_I)
...
??LPLD_SCCB_SendByte_0:
        ...
        UXTB     R0,R0            ;; ZeroExt  R0,R0,#+24,#+24
        CMP      R0,#+0
        BNE.N    ??LPLD_SCCB_SendByte_3
//  283   SCCB_SCL=0;
??LPLD_SCCB_SendByte_4:
        MOVS     R0,#+0
        LDR.N    R1,??DataTable7_2  ;; 0x43fe0800
        STR      R0,[R1, #+0]
//  284 }
