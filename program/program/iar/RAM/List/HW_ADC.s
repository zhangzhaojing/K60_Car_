...
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  C:\Users\19071_000\Desktop\K60_Car\lib\LPLD\HW\HW_ADC.c
//    Command line =  
//        -f C:\Users\19071_~1\AppData\Local\Temp\EWDE9D.tmp
//        (C:\Users\19071_000\Desktop\K60_Car\lib\LPLD\HW\HW_ADC.c -D LPLD_K60
//        -D USE_K60DZ10 -lCN
...
//    Locale       =  C
//    List file    =  
//        C:\Users\19071_000\Desktop\K60_Car\program\program\iar\RAM\List\HW_ADC.s
//
///////////////////////////////////////////////////////////////////////////////
...
// C:\Users\19071_000\Desktop\K60_Car\lib\LPLD\HW\HW_ADC.c
//    1 /**
//    2  * @file HW_ADC.c
...
??LPLD_ADC_Chn_Enable_6:
        ...
        MOVS     R0,#+0
        LDR.N    R2,??DataTable10_10  ;; 0x4004c000
        UXTB     R1,R1            ;; ZeroExt  R1,R1,#+24,#+24
        ADD      R1,R2,R1, LSL #+2
        STR      R0,[R1, #-4]
...
??LPLD_ADC_Chn_Enable_7:
        MOVS     R0,#+0
        LDR.N    R2,??DataTable10_11  ;; 0x4004a000
        UXTB     R1,R1            ;; ZeroExt  R1,R1,#+24,#+24
        ADD      R1,R2,R1, LSL #+2
        STR      R0,[R1, #-32]
        B.N      ??LPLD_ADC_Chn_Enable_15
??LPLD_ADC_Chn_Enable_8:
        MOVS     R0,#+0
        LDR.N    R2,??DataTable10_12  ;; 0x40049000
        UXTB     R1,R1            ;; ZeroExt  R1,R1,#+24,#+24
        ADD      R1,R2,R1, LSL #+2
        STR      R0,[R1, #-12]
        B.N      ??LPLD_ADC_Chn_Enable_15
...
??LPLD_ADC_Chn_Enable_10:
        MOVS     R0,#+0
        LDR.N    R2,??DataTable10_13  ;; 0x4004b000
        UXTB     R1,R1            ;; ZeroExt  R1,R1,#+24,#+24
        ADD      R1,R2,R1, LSL #+2
        STR      R0,[R1, #-56]
        B.N      ??LPLD_ADC_Chn_Enable_15
...
??LPLD_ADC_Chn_Enable_12:
        MOVS     R0,#+0
        LDR.N    R2,??DataTable10_14  ;; 0x4004d000
        UXTB     R1,R1            ;; ZeroExt  R1,R1,#+24,#+24
        ADD      R1,R2,R1, LSL #+2
        STR      R0,[R1, #+28]
        B.N      ??LPLD_ADC_Chn_Enable_15
