...
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  C:\Users\19071_000\Desktop\K60_Car\lib\LPLD\HW\HW_RTC.c
//    Command line =  
//        -f C:\Users\19071_~1\AppData\Local\Temp\EWE5EF.tmp
//        (C:\Users\19071_000\Desktop\K60_Car\lib\LPLD\HW\HW_RTC.c -D LPLD_K60
//        -D USE_K60DZ10 -lCN
...
//    Locale       =  C
//    List file    =  
//        C:\Users\19071_000\Desktop\K60_Car\program\program\iar\RAM\List\HW_RTC.s
//
///////////////////////////////////////////////////////////////////////////////
...
// C:\Users\19071_000\Desktop\K60_Car\lib\LPLD\HW\HW_RTC.c
//    1 /**
//    2  * @file HW_RTC.c
...
//   50   SIM->SCGC6 |= SIM_SCGC6_RTC_MASK;
        LDR.N    R5,??DataTable4_1  ;; 0x4004803c
        LDR      R5,[R5, #+0]
...
//   56   RTC->CR  &= ~RTC_CR_SWR_MASK;  
        LDR.N    R5,??DataTable4_2  ;; 0x4003d010
        LDR      R5,[R5, #+0]
        LSRS     R5,R5,#+1
        LSLS     R5,R5,#+1
        LDR.N    R6,??DataTable4_2  ;; 0x4003d010
...
//   67     RTC->IER |= (RTC_INT_INVALID & 0x07);//开启RTC无效数据中断
        LDR.N    R5,??DataTable4_3  ;; 0x4003d01c
        LDR      R5,[R5, #+0]
        ORRS     R5,R5,#0x1
        LDR.N    R6,??DataTable4_3  ;; 0x4003d01c
        STR      R5,[R6, #+0]
...
??LPLD_RTC_Init_2:
        LDR.N    R2,??DataTable4_3  ;; 0x4003d01c
        LDR      R2,[R2, #+0]
        LSRS     R2,R2,#+1
        LSLS     R2,R2,#+1
        LDR.N    R5,??DataTable4_3  ;; 0x4003d01c
...
??LPLD_RTC_Init_4:
        ...
        LDR      R2,[R2, #+0]
        BICS     R2,R2,#0x2
        LDR.N    R3,??DataTable4_3  ;; 0x4003d01c
        STR      R2,[R3, #+0]
//   83   }
//   84 
...
??LPLD_RTC_Init_7:
        MOVS     R2,#+0
        LDR.N    R3,??DataTable4_5  ;; 0x4003d00c
        STR      R2,[R3, #+0]
//   97   
//   98   //配置秒计数器
//   99   RTC->TSR = seconds;
        LDR.N    R2,??DataTable4_6  ;; 0x4003d000
        STR      R0,[R2, #+0]
//  100     
//  101   //配置报警寄存器
